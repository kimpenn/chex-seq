...
Summary:
    ...
    R1 -------------------->
                 <--------------------- R2
       |<------------------------------>| nonoverlapping mapped length
    
    When two mates overlap, the independent information content decreases, we hence would prefer those with less overlap given the same sum of mapped length. 


Usage:
    perl sam_mlen_mm.pl --inFile <input.bam|sam> [--outFile <output.txt>] [--endType PE] [--debug info] [--version] [--help] [--ncores 1]
